              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <input
                    type="email"
                    placeholder="Email"
                    className="w-full sm:w-auto px-4 py-2 bg-transparent border border-gray-600 text-white placeholder-gray-400 focus:outline-none focus:border-white"
                  />
                  <button className="w-full sm:w-auto px-4 py-2 bg-white text-black hover:bg-gray-200 transition-colors">
                    Subscribe
                  </button>
                </div>
