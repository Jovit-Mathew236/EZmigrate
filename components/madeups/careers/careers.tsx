          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <p className="text-gray-600 flex-1">
                We’re always looking for passionate and driven individuals to
                join our dynamic team. If you&apos;re ready to make a difference
                and grow with us, explore exciting opportunities and take your
                career to new heights. Together, let&apos;s create a lasting
                impact and achieve greatness.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-8">
            {[
              ...
              >
                ...
                <button className="flex items-center space-x-2 text-sm font-light hover:opacity-80">
                  <span>Apply Now</span>
